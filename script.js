...
export function createDivComponent() {
  ...
  div.textContent = 'This is a modular component';
  return div;
}
document.addEventListener('DOMContentLoaded', () => {
    const app = document.getElementById('app');
    import('./component.js').then(({ createDivComponent }) => {
      const component = createDivComponent();
      ...
      }, 2000); // Remove the loading text after 2 seconds
    });
  });
